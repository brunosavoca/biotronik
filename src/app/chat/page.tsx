                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <Button
                      ...
                      variant="outline"
                      disabled={isLoading}
                      className="quick-button-enter group relative overflow-hidden text-left justify-start h-auto py-4 px-6 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 border-red-200 dark:border-red-700 hover:shadow-xl hover:shadow-red-500/25 hover:scale-[1.02] transition-all duration-300 ease-out hover:border-red-300 dark:hover:border-red-600"
                    >
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 bg-red-500 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-red-500/40 transition-shadow duration-300">
        ...
        <div className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-6 py-4">
          ...
          <div className="flex items-end space-x-3">
            ...
            <Button
              ...
              className="shrink-0 bg-red-500 hover:bg-red-600 text-white rounded-full p-3 button-press disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
